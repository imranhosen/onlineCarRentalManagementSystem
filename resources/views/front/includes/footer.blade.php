    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-12 col-lg-3">
                <figure class="footer_logo"><a href="#"><span><em>Celebrating</em>This<strong>YEARS</strong></span><i class="icon-111"></i></a></figure>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                ...
                <ul class="footer-list">
                    ...
                    <li><a href="{{ url('/help') }}">Help renting a car</a></li>
                    <li><a href="{{ url('/condition') }}">Terms and Conditions</a></li>
                </ul>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                <div class="contact-info">
                    <span class="phone_number"><i class="icon-telephone"></i>01749207035</span>

                    <span class="location_info">
							<i class="icon-placeholder-for-map"></i>
							<em>The Company Name Inc.</em>
							<em>Daffodil International University,</em>
							<em>Sukrabad, Dhanmondi 32</em> </span>
                </div>
            </div>
        </div>
    </div>
